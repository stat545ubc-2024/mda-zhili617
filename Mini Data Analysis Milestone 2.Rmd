...
**genres**: List of genres for the game, separated by a comma (e.g. Action, RPG, ...). This is *untidy* because for some cells there exist multiple genres in a single cell.
...
Overall, tidy variables are types, discount_price, original_price, release_date; the untidy variables are languages, game_details, genres, publisher. Hence, the data set steam_games is currently untidy due to multiple values in several cells.
