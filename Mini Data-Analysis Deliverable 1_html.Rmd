...
```{r}
ggplot(steam_games, aes(x = is.na(discount_price), y = achievements)) +
    geom_boxplot() +
    ggtitle("Boxplot of Achievements Based on Missing Discount Price") +
    xlab("Missing Discount Price") +
    ylab("Achievements")
