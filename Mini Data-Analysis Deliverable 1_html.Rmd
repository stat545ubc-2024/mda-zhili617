...
bind_rows(apt_buildings_attributes, parking_meters_attributes, vancouver_trees_attributes,steam_games_attributes ) #Combine the four data frames containing attributes of different datasets into a single data frame.
```
