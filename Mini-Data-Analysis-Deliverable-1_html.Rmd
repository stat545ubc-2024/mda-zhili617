...
print(numeric_variables) #by this step found except id, there are only 3 numberic variables
...
steam_games_discount_price<- ggplot(steam_games, aes(x = discount_price)) +
  geom_histogram(binwidth = 1, fill = "blue", color = "black", alpha = 0.7, na.rm = TRUE)
print(steam_games_discount_price)
```
